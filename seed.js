...
(async () => {
  try {
    ...
    const clients = await Client.bulkCreate([
      ...
      { name: 'Bob Martin', email: 'bob.martin@example.com', phone: '0605060708', notes: 'notes' },
      { name: 'Charlie Durand', email: 'charlie.durand@example.com', phone: '0608091011', notes: 'À relancer' },
      { name: 'David Leroy', email: 'david.leroy@example.com', phone: '0611121314', notes: 'notes' },
      ...
      { name: 'Hugo Robert', email: 'hugo.robert@example.com', phone: '0627282930', notes: 'notes' },
      { name: 'Isabelle Fabre', email: 'isabelle.fabre@example.com', phone: '0631323334', notes: 'notes' },
      { name: 'Julien Marchand', email: 'julien.marchand@example.com', phone: '0635363738', notes: 'Client régulier' }
    ]);

    // --- Base dynamique : demain à minuit ---
